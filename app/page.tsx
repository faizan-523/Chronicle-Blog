...
export default function Home() {
  ...
  // Other latest posts (limit to 3 for clean design)
  const latestPosts = MOCK_POSTS.filter((post) => post.id !== featuredPost.id).slice(0, 3);
    ...
    <div className="flex flex-col w-full">
            ...
            <div className="relative group bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 grid grid-cols-1 lg:grid-cols-12 gap-0">
              ...
              <div className="p-8 sm:p-12 lg:col-span-5 flex flex-col justify-center">
                <div className="flex items-center space-x-2 mb-4">
                  <span className="text-xs font-semibold text-violet-600 tracking-wider uppercase">Featured Post</span>
                ...
                <div className="mt-auto flex items-center justify-between pt-6 border-t border-gray-100">
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <p className="text-xs font-bold text-violet-600 mt-0.5">{featuredPost.readingTime}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="flex items-center justify-between mb-10">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Latest Stories</h2>
            <p className="text-sm text-gray-500 mt-1">Explore our recently published articles</p>
          </div>
          <Link
            href="/blog"
